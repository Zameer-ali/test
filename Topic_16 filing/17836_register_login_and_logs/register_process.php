...
if (isset($_REQUEST['submit'])) {
    ...
    if ($is_validate) {
        $role_id=2;
     $insert_query="INSERT INTO users(first_name,last_name,email,password,cnic,phone_no,role_id) VALUES(?,?,?,?,?,?,?)";
      $stmt = mysqli_prepare($connection,$insert_query);
      mysqli_stmt_bind_param($stmt,"ssssssi",$first_name,$last_name,$email,$password,$cnic,$phone_no,$role_id);
