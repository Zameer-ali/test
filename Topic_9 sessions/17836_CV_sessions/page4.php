...
<body>
    ...
    <table align='center' border='1' width='75%' cellspacing="0" cellpadding="4">
            ...
            <tr>
                <td>Name:</td>
                <td colspan="100%"><?php echo $_SESSION['name']??''; ?></td>
            </tr>
            <tr>
                <td>Father's Name:</td>
                <td colspan="100%"><?php echo $_SESSION['fname']??''; ?></td>
            </tr>
            <tr>
                <td>Gender:</td>
                <td colspan="100%"><?php echo $_SESSION['gender']??''; ?></td>
            </tr>
            <tr>
                <td>Country:</td>
                <td colspan="100%"><?php echo $_SESSION['country']??''; ?></td>
            </tr>
            <tr>
                <td colspan="100%">
            ...
            <tr>
                <td>Contact NO:</td>
                <td colspan="100%"><?php echo $_SESSION['phone']??''; ?></td>
            </tr>
            <tr>
                <td>Email:</td>
                <td colspan="100%"><?php echo $_SESSION['email']??''; ?></td>
            </tr>
            <tr>
                <td>Address:</td>
                <td colspan="100%"><?php echo $_SESSION['address']??''; ?></td>
            </tr>
            <tr>
                <td colspan="100%">
